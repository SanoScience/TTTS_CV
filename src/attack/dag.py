'''
Code taken from: https://github.com/IFL-CAMP/dense_adversarial_generation_pytorch
...
import torch
from attack.util import make_one_hot


def DAG(model, image, ground_truth, adv_target, num_iterations=20, gamma=0.07, no_background=True, background_class=0,
